...
<template>
  <aside class="sidebar" :class="{ open: appStore.sidebarOpen, collapsed: appStore.sidebarCollapsed, 'sidebar-presales': presalesMode }">
    ...
    <nav class="sidebar-nav">
      ...
      <div v-if="!presalesMode" class="nav-group">
        ...
        <div v-show="!isGroupCollapsed('conversation')" class="nav-group-items">
          ...
          <RouteLinkItem v-if="!isSidebarItemHidden('groupChat')" class="nav-item" :to="{ name: 'hermes.groupChat' }" :active="isNavActive('hermes.groupChat', 'hermes.groupChatRoom')">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
          ...
          <a v-if="!isSidebarItemHidden('apiRelay')" class="nav-item fun-link" href="https://apikey.fun/register?aff=LIBAPI" target="_blank" rel="noopener noreferrer">
      ...
      <div v-if="!isSidebarGroupHidden('agent')" class="nav-group">
        ...
        <div v-show="!isGroupCollapsed('agent')" class="nav-group-items">
          <RouteLinkItem v-if="!presalesMode" class="nav-item" :to="{ name: 'hermes.jobs' }" :active="selectedKey === 'hermes.jobs'">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
          ...
          <RouteLinkItem v-if="!presalesMode" class="nav-item" :to="{ name: 'hermes.kanban' }" :active="selectedKey === 'hermes.kanban'">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
          ...
          <RouteLinkItem v-if="!presalesMode" class="nav-item" :to="{ name: 'hermes.channels' }" :active="selectedKey === 'hermes.channels'">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
          ...
          <RouteLinkItem v-if="!presalesMode" class="nav-item" :to="{ name: 'hermes.mcp' }" :active="selectedKey === 'hermes.mcp'">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
              <path d="M4 7V4h16v3" />
              <path d="M9 20h6" />
              <path d="M12 7v13" />
    ...
    <div class="sidebar-footer">
      ...
      <div v-if="!presalesMode" class="version-info">
        <div v-if="!isGithubLinkHidden() || !isWebsiteLinkHidden()" class="version-links">
          <a v-if="!isGithubLinkHidden()" class="github-link" href="https://github.com/EKKOLearnAI/hermes-web-ui" target="_blank" rel="noopener noreferrer" title="GitHub">
          ...
          <a v-if="!isWebsiteLinkHidden()" class="website-link" href="https://hermes-studio.ai/" target="_blank" rel="noopener noreferrer" title="Website">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>
          </a>
        </div>
        <span v-if="!isStudioVersionHidden()" class="version-text" @click="openChangelog">Studio v{{ appStore.serverVersion || "0.1.0" }}</span>
        <ThemeSwitch />
      </div>
      <template v-if="!presalesMode">
